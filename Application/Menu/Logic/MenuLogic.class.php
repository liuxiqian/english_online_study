...
{
	/**
	 * 获取 某模块 在开发/非开发（自动实别） 模式下的菜单列表
	 * @param  string $module 模块名
	 * @param  int $IsDev  是否开发模块
	 * @return lists         
	 */
	public function getListsByIdDev($module="Admin", $IsDev = null)
	{
		return $this->getListByIsDev($module="Admin", $IsDev = null);
	}
