...
class Word extends Model
{
    ...
    private function _setData($data) {
        ...
        $this->ukPhonetic       = (string)$data['uk_phonetic'];
        $this->usPhonetic       = (string)$data['us_phonetic'];
        $this->translation      = (string)$data['translation'];
        $this->star             = (int)$data['star'];
        $this->courseId         = (int)$data['course_id'];
        $this->syllable         = (string)$data['syllable'];
        $this->example          = (string)$data['example'];
        $this->exampleTranslate = (string)$data['example_translate'];
        $this->attachmentId     = (int)($data['attachment_id']);
        $this->nextId           = (int)$data['next_id'];
        $this->preId            = (int)$data['pre_id'];
