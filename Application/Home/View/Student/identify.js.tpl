<script>
    ...
    // 点击正确选项出现对号错号
    $scope.choice = [
        {value:"0", title:"习惯，习性",check:"fa fa-check true",times:"fa fa-times false"},
        {value:"1", title:"可乐",check:"fa fa-check true",times:"fa fa-times false"},
        {value:"0", title:"（美）甜饼干，曲奇饼",check:"fa fa-check true",times:"fa fa-times false"},
        {value:"0", title:"压力；紧张",check:"fa fa-check true",times:"fa fa-times false"},
    ]
    $scope.myVar = 0;
    $scope.select = "";
