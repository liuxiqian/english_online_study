                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="{:U('save',I('get.'))}" method='post' id="demoForm">
                        <div class="form-group">
                            <label for="name" class="col-md-2 control-label">单词内容</label>
                            <div class="col-md-4">
                                <input class="form-control" name="name" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-md-2 control-label">单词性质</label>
                            <div class="col-md-4">
                                <input class="form-control" name="title" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-md-2 control-label">例句(中文)</label>
                            <div class="col-md-4">
                                <input class="form-control" name="title" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="title" class="col-md-2 control-label">例句(英文)</label>
                            <div class="col-md-4">
                                <input class="form-control" name="title" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4">
                                <button type="submit" class="btn btn-succss" onclick="location='{:U(index)}'"><i class="fa fa-check "></i> 确认</button>
                            </div>
                        </div>
                    </form>
                </div>
